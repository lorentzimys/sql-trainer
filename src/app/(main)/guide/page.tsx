        ...
        <Section className={styles.hero}>
          <div className="flex flex-1 flex-col gap-2 max-w-[600px]">
            ...
            <span className="text-1xl">
              ...
              изменить твоё отношение к SQL. Мы вместе пройдём путь, чтобы
              понять как этот язык работает, и получим все необходимые навыки
              для эффективного применения его на работе.
            </span>
          </div>
